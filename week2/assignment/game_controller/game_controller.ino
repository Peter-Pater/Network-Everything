...
//  Serial.println(sensorValue2);
  ...
  else if (sensorValue1 > 340) {
    sensorValue1 = -1;
  }
  else if (sensorValue1 <= 340 && sensorValue1 >= 320) {
    sensorValue1 = 0;
  }
  ...
  else if (sensorValue2 > 340) {
    sensorValue2 = -1;
  }
  else if (sensorValue2 <= 340 && sensorValue2 >= 320) {
    sensorValue2 = 0;
  }
  ...
  else if (sensorValue4 > 340) {
    sensorValue4 = -1;
  }
  else if (sensorValue4 <= 340 && sensorValue4 >= 320) {
    sensorValue4 = 0;
  }
  ...
  else if (sensorValue5 > 340) {
    sensorValue5 = -1;
  }
  else if (sensorValue5 <= 340 && sensorValue5 >= 320) {
    sensorValue5 = 0;
  }
